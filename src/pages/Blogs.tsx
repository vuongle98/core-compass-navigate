  ...
  const mockBlogs = [
    {
      ...
      excerpt:
        "Learn how to use React Hooks to simplify your components and share stateful logic.",
    ...
    },
    {
      ...
      excerpt:
        "Stay ahead of the competition with these effective SEO strategies for 2023.",
