...
class LoggingService {
  ...
  static error(message: string | Error, contextOrData?: unknown, description?: string, data?: unknown) {
    if (LoggingService.config.enableConsole) {
  ...
  static info(module: string, action?: string, description?: string, data?: unknown) {
    if (LoggingService.config.enableConsole) {
  ...
  static warn(module: string, action?: string, description?: string, data?: unknown) {
    if (LoggingService.config.enableConsole) {
      if (action && description) {
  ...
  static warning(module: string, action?: string, description?: string, data?: unknown) {
    return this.warn(module, action, description, data);
  }

  static debug(module: string, action?: string, description?: string, data?: unknown) {
