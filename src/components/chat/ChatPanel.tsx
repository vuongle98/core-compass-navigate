...
const ChatPanel: React.FC<ChatPanelProps> = ({ onClose }) => {
  ...
  const handleChatSelect = (chatId: string) => {
    ...
    LoggingService.info('chat', 'chat_selected', 'User selected a chat', { chatId });
  ...
  const handleCreateChat = () => {
    ...
    LoggingService.info('chat', 'create_chat_dialog_opened', 'User opened create chat dialog');
  };
    ...
    if (chatList.length === 0) {
      return (
        <div className="p-3 text-center text-sm text-muted-foreground">
          No chats found
          <Button variant="link" size="sm" onClick={handleCreateChat} className="ml-1 p-0">
            Create one?
          </Button>
        </div>
      );
          ...
          <div className="flex-1 flex overflow-hidden">
            <CardContent className="p-0 flex-1 flex">
              <div className="flex h-full w-full relative">
                ...
                <div className={`${showChatList ? 'flex flex-col' : 'hidden'} md:flex md:flex-col w-full md:w-1/3 border-r overflow-hidden`}>
                ...
                <div className={`${!showChatList ? 'flex flex-col' : 'hidden'} md:flex md:flex-col w-full md:w-2/3 h-full overflow-hidden`}>
                  {activeChat ? (
                    <>
                    ...
                    <div className="flex-1 flex items-center justify-center text-muted-foreground flex-col p-4">
                      ...
                      <Button variant="outline" size="sm" className="mt-2" onClick={handleCreateChat}>
