...
const CreateChatDialog = ({ isOpen, onClose }: CreateChatDialogProps) => {
  ...
  const handleCreateChat = async () => {
    ...
    try {
      LoggingService.info('chat', 'chat_creation_started', 'User initiated chat creation', { 
        chatType: activeTab, 
      ...
      if (activeTab === 'public') {
        if (!chatName.trim()) {
          toast({ description: "Please enter a chat name", variant: "destructive" });
          return;
        }
      ...
      LoggingService.error('chat', 'chat_creation_failed', 'Failed to create chat', { error });
      toast({ 
        title: "Error",
