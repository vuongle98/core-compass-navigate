...
const ServiceManagement = () => {
  ...
  const {
    ...
    queryFn: async ({ page, size, filters }) => {
  ...
  const handleServiceAction = async (service: Service, action: 'start' | 'stop') => {
    try {
      ...
      if (response.success) {
        toast.success(`Service ${action === 'start' ? 'started' : 'stopped'} successfully`);
        refresh();
      } else {
  ...
  const handleCreateService = async (serviceData: any) => {
    try {
      const response = await ServiceManagementService.createService(serviceData);
    ...
    <div className="flex min-h-screen h-screen overflow-hidden">
      ...
      <main className="flex-1 overflow-y-auto p-4 md:p-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
          <Card className="bg-secondary/10 hover:bg-secondary/20 transition-colors cursor-pointer" onClick={() => handleTabChange('all')}>
          ...
          <Card className="bg-green-500/10 hover:bg-green-500/20 transition-colors cursor-pointer" onClick={() => handleTabChange('running')}>
            <CardContent className="flex items-center justify-between p-4">
              <div>
          ...
          <Card className="bg-orange-500/10 hover:bg-orange-500/20 transition-colors cursor-pointer" onClick={() => handleTabChange('stopped')}>
            <CardContent className="flex items-center justify-between p-4">
              <div>
          ...
          <Card className="bg-red-500/10 hover:bg-red-500/20 transition-colors cursor-pointer" onClick={() => handleTabChange('error')}>
            <CardContent className="flex items-center justify-between p-4">
              <div>
